...
let grupos = [gp1, gp2, channel]
let gata = [imagen1, imagen2, imagen4, imagen6, imagen3]
let enlace = { contextInfo: { externalAdReply: {title: wm + ' 🚩', body: 'support group' , sourceUrl: grupos.getRandom(), thumbnail: await(await fetch(gata.getRandom())).buffer() }}}
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '💚 𝗦𝘂𝗽𝗲𝗿 𝗚𝗼𝗸𝘂𝗕𝗼𝘁-𝗠𝗗 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: yt }}}
let dos = [channel, gp1]
...
`
await conn.sendFile(m.chat, imagen1, 'gata.jpg', caption, m)
//await conn.sendButton(m.chat, wm, caption, gata.getRandom(), [['𝗠 𝗘 𝗡 𝗨 ☘️', '/menu']], m,
} catch (e) {
