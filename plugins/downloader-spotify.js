...
let frep = { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: md, body: wm, previewType: 0, thumbnail: imagen6, sourceUrl: channel}}}
if (!text) return await conn.reply(m.chat, `*${usedPrefix + command} ozuna*`, m, {contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: md, body: wm, previewType: 0, thumbnail: imagen6, sourceUrl: channel}}})    
try {
