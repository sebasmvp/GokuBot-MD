//Menu adaptado por Jostin
//DEJAD DE ROBAR CODIGO.
...
await conn.sendMessage(m.chat, {text: `╭̟̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩.....․⁀⸱⁀⸱︵૰⳹․㊪․⳼૰︵⸱⁀⸱⁀․.....╮̟̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩̩
      ┈┈┈┈┈⃐ᤢ࣪࣪ Cẚᵣgᵃₙdₒ┈⃐ᤢ࣪࣪┈┈┈┈   
 li.𒉡.𓂃.JOSTIN:.ᯤ̸ׄ↯ׄᤷ♡..ᴏғɪͦᴄᷫɪͨᴀʟ°.il
...
handler.command = /^(menu|menú|memu|memú|help|info|comandos|allmenu|2help|menu1.2|ayuda|menu.goku|commands|commandos|cmd)$/i;
handler.exp = 50;
handler.fail = null;
